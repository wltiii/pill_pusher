...
void main() {
  ...
  test('instantiates a PillSet from json', () {
    ...
    expect(pillSet.toString(),
        equals('PillSet(Morning, Daily, [Pill(C, 250 mg - 1/2 of 500 mg), Pill(D3, 50 mcg (2000 IU)), Pill(Fish (Krill) Oil, 500 mg), Pill(Glipizide Er 24hr, 10 mg), Pill(Probiotic, One capsule), Pill(Zinc, 25 mg - 1/2 of 50 mg), Pill(Extra Virgin Olive Oil, Two tablespoons)])'));
  });
}